...
namespace Levelbot.Actions.Combat
{
    ...
    {
        public static Composite CreatePreCombatBehavior()=>GapCases.Leaf("isolation-pre");
        public static Composite CreateRetreatBehavior()=>GapCases.Leaf("isolation-retreat");
    }
}
