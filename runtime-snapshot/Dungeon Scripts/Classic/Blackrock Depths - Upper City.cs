...
#endif
{
    public class BlackrockDepthsUpperCity : Dungeon
    {
                        ...
                        new Decorator(
                            ...
                            new PrioritySelector(
                                ...
                                new Decorator(
                                    ...
                                    new TreeSharp.Action(ctx => ScriptHelpers.MoveTankTo(_ringOfLawCenterLocation))),
                                new Decorator(
                        ...
                        new Decorator(
                            ...
                            new PrioritySelector(
                                ...
                                new Decorator(
                                    ...
                                    new TreeSharp.Action(ctx => ScriptHelpers.MoveTankTo(wave2Door.Location))),
                                new Decorator(
                        ...
                        new Decorator(
                            ...
                            new PrioritySelector(
                                ...
                                new Decorator(
                                    ...
                                    new TreeSharp.Action(ctx => ScriptHelpers.MoveTankTo(wave1Door.Location))),
                                new Decorator(
                ...
                new Decorator(
                    ...
                    new PrioritySelector(
                        new Decorator(
                            ...
                            new TreeSharp.Action(ctx => ScriptHelpers.MoveTankTo(shadowForgeLock.Location))),
                        new Decorator(
                        ...
                        new Decorator(
                            ...
                            new PrioritySelector(
                                new Decorator(
                                    ...
                                    new TreeSharp.Action(ctx => Navigator.GetRunStatusFromMoveResult(Navigator.MoveTo(_ribblyScrewspigotDpsSpot)))),
                                new Decorator(
                                    ctx => ScriptHelpers.MovementEnabled && StyxWoW.Me.Location.DistanceSqr(_ribblyScrewspigotDpsSpot) <= 4 * 4,
                                    new TreeSharp.Action(ctx => ScriptHelpers.DisableMovement(() => ScriptHelpers.IsBossAlive("Ribbly Screwspigot") && StyxWoW.Me.IsAlive)))
                                )))));
        }
                ...
                // do we need to buy Dark Iron Ale Mug?
                            new DecoratorContinue(
                                ...
                                new Sequence(
                                    ...
                                    new TreeSharp.Action(ctx => pluggerSpazzring.Interact()),
                                    new WaitContinue(2, ctx => MerchantFrame.Instance.IsVisible, new ActionAlwaysSucceed()),
                                    new TreeSharp.Action(ctx => ScriptHelpers.BuyItem(11325, 6 - mugsInBag)),
                            ...
                            new TreeSharp.Action(ctx => Logger.Write("{0} in bag", mugsInBag)),
                            new DecoratorContinue(
                                ctx => StyxWoW.Me.IsTank() && mugsInBag >= 6,
                                new Sequence(
                ...
                new PrioritySelector(
                    new Decorator(
                        ...
                        new Sequence(
                            ...
                            new TreeSharp.Action(ctx => _talkedToDoomrelt = true))),
                    new Decorator(
        ...
        public Composite ChestOfTheSevenHandler()
        {
            return new Decorator(
                ...
                new Sequence(
                    ...
                    new TreeSharp.Action(ctx => ((WoWGameObject)ctx).Interact()),
                    new WaitContinue(10, ctx => false, new ActionAlwaysSucceed()),
                    new TreeSharp.Action(ctx => _lootedChestOfTheSeven = true)));
        }
                        ...
                        new PrioritySelector(
                            new Decorator(
                                ...
                                new PrioritySelector(
                                    ...
                                    new TreeSharp.Action(ctx => ScriptHelpers.MoveTankTo(_northBrazierLocation)))),
                            new Decorator(
                        ...
                        new PrioritySelector(
                            new Decorator(
                                ...
                                new PrioritySelector(
                                    ...
                                    new TreeSharp.Action(ctx => ScriptHelpers.MoveTankTo(_southBrazierLocation)))),
                            new Decorator(
                ...
                new Decorator(
                    ...
                    new PrioritySelector(
                        new Decorator(
                            ...
                            new TreeSharp.Action(ctx => Navigator.GetRunStatusFromMoveResult(Navigator.MoveTo(_magmusPartyMoveToLocation)))))));
        }
    }
}