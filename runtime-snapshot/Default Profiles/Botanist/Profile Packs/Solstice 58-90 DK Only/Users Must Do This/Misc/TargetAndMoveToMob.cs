...
namespace Honorbuddy.Quest_Behaviors.TargetAndMoveToMob
{
	...
	public class TargetAndMoveToMob : QuestBehaviorBase
	{
		...
		public override string SubversionId { get { return "$Id: TargetAndMoveToMob.cs 1590 2014-07-17 13:05:31Z highvoltz $"; } }
		public override string SubversionRevision { get { return "$Rev: 1590 $"; } }
		#endregion
