...
namespace Singular.Helpers
{
    internal static class Unit
    {
        ...
        {
            return unit != null &&
                   (unit.CreatureType == WoWCreatureType.Undead ||
        ...
        {
            return unit != null && unit.CanSelect && unit.Attackable && !unit.IsFriendly && !unit.Dead &&
                   !unit.IsPet && unit.OwnedByRoot == null && !unit.IsNonCombatPet && !unit.IsCritter;
        }
        ...
        static bool ValidUnit(WoWUnit p)
        {
            ...
            // In a dungeon, Combat Bot assists only enemies already engaged with our group.
            // A unit being in combat somewhere in the instance is not sufficient.
            if (!p.IsEligibleDungeonCombatTarget())
                return false;
        ...
        {
            return unit != null && Lists.BossList.BossIds.Contains(unit.Entry);
        }

        public static bool IsTrainingDummy(this WoWUnit unit)
        {
            return unit != null && Lists.BossList.TrainingDummies.Contains(unit.Entry);
        }
